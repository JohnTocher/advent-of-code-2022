...
col_num = 0  # to act as keys for our dictionary, whch will contain heights
...
with open(INPUT_FILE_NAME, "r") as input_file:
    for each_line in input_file:
        ...
        for each_char in clean_line:
            ...
            print(f"{this_location} : {this_height}")
        print(f"{clean_line}")
...
for row_num in range(2, forest_width):  # Loops don't reach the final value
    for col_num in range(2, forest_width):
        ...
        print(f"Adjecent trees: {adjacent_trees}")
